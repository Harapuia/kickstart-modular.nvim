...
```sh
git clone https://github.com/harapuia/kickstart-modular.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/harapuia/kickstart.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/harapuia/kickstart.nvim.git "${env:LOCALAPPDATA}\nvim"
```
